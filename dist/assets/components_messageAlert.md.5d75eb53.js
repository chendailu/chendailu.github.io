import{_ as c,c as i,e as n,a,b as t,w as p,d as C,r as A,o as d}from"./app.bce86307.js";const y={methods:{third(o){this.$messageAlert({type:o,msg:"\u6210\u529F\u7684\u6D88\u606F",icon:"xly_icon_zhengque",top:"30px",timeOut:2,align:"left"}).then(()=>{console.log("ok")}).catch(()=>{console.log("no"+o)})}}},k=JSON.parse('{"title":"messageAlert","description":"","frontmatter":{"title":"messageAlert","pageClass":"xly-class"},"headers":[],"relativePath":"components/messageAlert.md"}'),g=a("h1",{id:"\u793A\u4F8B",tabindex:"-1"},[n("\u793A\u4F8B "),a("a",{class:"header-anchor",href:"#\u793A\u4F8B","aria-hidden":"true"},"#")],-1),_=a("br",null,null,-1),u={style:{overflow:"hidden"}},m=a("h4",null,"\u63D0\u793A\u7C7B",-1),D=C(`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;"></span></span>
